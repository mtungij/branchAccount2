...
<div class="p-4 sm:p-6">
  ...
  <div class="mt-6 flex justify-end items-center gap-x-2">
    ...
    <button
      type="submit"
      id="depositSubmitBtn"
      class="py-2 px-3 btn-primary-sm bg-cyan-600 hover:bg-cyan-700 text-white inline-flex items-center gap-2"
    >
      <svg id="depositSubmitSpinner" class="hidden animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
