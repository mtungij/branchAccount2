...
<div class="grid sm:grid-cols-12 gap-4 sm:gap-6">
    ...
    <div class="sm:col-span-4">
        ...
        <?php
        $sponsor_passport_path = isset($sponser->passport_path) ? trim((string) $sponser->passport_path) : '';
        $fallback_passport_path = isset($existing_sponsor_passport) ? trim((string) $existing_sponsor_passport) : '';
        $resolved_passport_path = $sponsor_passport_path !== '' ? $sponsor_passport_path : $fallback_passport_path;
        $has_passport = $resolved_passport_path !== '';
        ?>
        <div id="existingPassportSection" class="<?php echo $has_passport ? '' : 'hidden'; ?>">
            <div class="flex items-center gap-3 mb-2">
                <img id="sponsorPreviewImage" class="rounded border shadow w-32 h-32 object-cover"
                     src="<?php echo $has_passport ? base_url($resolved_passport_path) : base_url('assets/img/customer21.png'); ?>"
                     alt="Preview">
